...
const FITNESS_JOURNEY_PROJECT_ID = "e5f6a7b8-c9d0-4123-e5f6-a7b8c9d0e1f2";
...
export const TODO_DYNAMO_MOCKS: TodoDynamoDBEntity[] = [
	...
	// ========== PROJECT TODOS WITHOUT SECTION ==========
	// Python Study Plan - todo sem section (a triar)
	{
		PK: `USER#${MOCK_USER_ID}#PROJECT#${PYTHON_PROJECT_ID}`,
		SK: "TODO#PENDING#0#todo-python-no-section-1",
		id: "todo-python-no-section-1",
		user_id: MOCK_USER_ID,
		project_id: PYTHON_PROJECT_ID,
		section_id: null,
		title: "Decide which Python framework to use",
		description: "Compare Flask vs FastAPI for the project",
		completed: false,
		order: 0,
	...
	{
		PK: `USER#${MOCK_USER_ID}#PROJECT#${PYTHON_PROJECT_ID}`,
		SK: "TODO#PENDING#1#todo-python-no-section-2",
		id: "todo-python-no-section-2",
		user_id: MOCK_USER_ID,
		project_id: PYTHON_PROJECT_ID,
		section_id: null,
		title: "Review Python learning path",
		description: "Check if we need to add more topics to the plan",
		completed: false,
		order: 1,
	...
	// Personal Goals 2025 - todo sem section
	{
		PK: `USER#${MOCK_USER_ID}#PROJECT#${PERSONAL_GOALS_PROJECT_ID}`,
		SK: "TODO#PENDING#0#todo-goals-no-section-1",
		id: "todo-goals-no-section-1",
		user_id: MOCK_USER_ID,
		project_id: PERSONAL_GOALS_PROJECT_ID,
		section_id: null,
		title: "Define Q1 health goals",
		description: "Set specific targets for exercise and nutrition",
		completed: false,
		order: 0,
		created_at: "2026-01-26T09:00:00.000Z",
		updated_at: "2026-01-26T09:00:00.000Z",
	...
	// Fitness Journey - Weekly Goals (sec-fitness-001)
	{
		PK: `USER#${MOCK_USER_ID}#PROJECT#${FITNESS_JOURNEY_PROJECT_ID}`,
		SK: "TODO#PENDING#1#todo-fitness-weekly-1",
		GSI3PK: `USER#${MOCK_USER_ID}#PROJECT#${FITNESS_JOURNEY_PROJECT_ID}#SECTION#sec-fitness-001`,
		GSI3SK: "TODO#PENDING#1#todo-fitness-weekly-1",
		id: "todo-fitness-weekly-1",
		user_id: MOCK_USER_ID,
		project_id: FITNESS_JOURNEY_PROJECT_ID,
		section_id: "sec-fitness-001",
		title: "Run 3km twice this week",
		description: "Focus on maintaining a steady pace",
		completed: false,
		order: 1,
		created_at: "2026-01-30T07:00:00.000Z",
		updated_at: "2026-01-30T07:00:00.000Z",
		completed_at: null,
		due_date: "2026-02-20T23:59:59.000Z",
		priority: "medium",
		entity_type: "TODO",
	...
	{
		PK: `USER#${MOCK_USER_ID}#PROJECT#${FITNESS_JOURNEY_PROJECT_ID}`,
		SK: "TODO#PENDING#2#todo-fitness-weekly-2",
		GSI3PK: `USER#${MOCK_USER_ID}#PROJECT#${FITNESS_JOURNEY_PROJECT_ID}#SECTION#sec-fitness-001`,
		GSI3SK: "TODO#PENDING#2#todo-fitness-weekly-2",
		id: "todo-fitness-weekly-2",
		user_id: MOCK_USER_ID,
		project_id: FITNESS_JOURNEY_PROJECT_ID,
		section_id: "sec-fitness-001",
		title: "Do 3 strength workouts",
	...
	// Fitness Journey - Completed (sec-fitness-002)
	{
		PK: `USER#${MOCK_USER_ID}#PROJECT#${FITNESS_JOURNEY_PROJECT_ID}`,
		SK: "TODO#COMPLETED#2026-02-01T10:00:00.000Z#todo-fitness-done-1",
		id: "todo-fitness-done-1",
		user_id: MOCK_USER_ID,
		project_id: FITNESS_JOURNEY_PROJECT_ID,
		section_id: "sec-fitness-002",
		title: "Buy running shoes",
		description: "Choose a pair with good cushioning",
		completed: true,
		order: 1,
	...
	// Fitness Journey - todos without section (for project detail view)
	{
		PK: `USER#${MOCK_USER_ID}#PROJECT#${FITNESS_JOURNEY_PROJECT_ID}`,
		SK: "TODO#PENDING#0#todo-fitness-no-section-1",
		id: "todo-fitness-no-section-1",
		user_id: MOCK_USER_ID,
		project_id: FITNESS_JOURNEY_PROJECT_ID,
		section_id: null,
		title: "Schedule annual health checkup",
		description: "Blood tests and general evaluation",
		completed: false,
		order: 0,
		created_at: "2026-01-29T09:00:00.000Z",
		updated_at: "2026-01-29T09:00:00.000Z",
