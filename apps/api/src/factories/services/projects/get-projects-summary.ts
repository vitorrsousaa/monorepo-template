import {
	GetProjectsSummaryService,
	type IGetProjectsSummaryService,
} from "@application/modules/projects/services/get-projects-summary/service";
...
export function makeGetProjectsSummaryService(): IGetProjectsSummaryService {
	...
	return new GetProjectsSummaryService(projectRepository, taskRepository);
}
