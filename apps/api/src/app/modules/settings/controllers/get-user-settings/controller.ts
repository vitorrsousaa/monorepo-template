...
import type { IGetUserSettingsService } from "@application/modules/settings/services/get-user-settings";
import type { GetByUserSettingsResponse } from "@repo/contracts/settings/get-by-user";
